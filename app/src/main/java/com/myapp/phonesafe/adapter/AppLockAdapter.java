...
public class AppLockAdapter extends BaseAdapter {
	...
	public AppLockAdapter(Context context, List<AppInfo> mUserInfodatas,
   ...
   //列表项视图
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageView iconIv=(ImageView)convertView.findViewById(R.id.applock_item_icon_iv);
		TextView nameTv=(TextView)convertView.findViewById(R.id.applock_item_name_tv);
		TextView installTv=(TextView)convertView.findViewById(R.id.applock_item_install_tv);
		TextView sizeTv=(TextView)convertView.findViewById(R.id.applock_item_size_tv);
		ImageView lockIv=(ImageView)convertView.findViewById(R.id.applock_item_lock_iv);
		...
		String formatFileSize = Formatter.formatFileSize(context, appInfo.size);//把字节数转换为kB或者MB
